class GrowSystemPanel extends HTMLElement {
  ...
  _activeStageSummary() {
    ...
    const labels = {germination:"Çimlenme",early_veg:"Erken veg",veg:"Veg",bloom:"Çiçeklenme",darkness:"Karanlık",harvest:"Hasat / Kurutma"};
  ...
  _profiles() {
    const order=["germination","early_veg","veg","bloom","darkness","harvest"],labels={germination:"Çimlenme",early_veg:"Erken veg",veg:"Veg",bloom:"Çiçeklenme",darkness:"Karanlık",harvest:"Hasat / Kurutma"},icons={germination:"mdi:sprout",early_veg:"mdi:leaf",veg:"mdi:flower",bloom:"mdi:flower-pollen",darkness:"mdi:weather-night",harvest:"mdi:content-cut"};
